    ...
    public class ARPGItem : GlobalItem
    {
        ...
        public override void GetWeaponDamage(Item item, Player player, ref int damage)
        {
            ...
            if (itemType.Equals("weapon"))
            {
                ...
                {
                    modItem.onHit = "Fire";
                    modItem.onHitChance = modifierValues[HasMod(15)];
                ...
                {
                    modItem.onHit = "Frostburn";
                    modItem.onHitChance = modifierValues[HasMod(16)];
                ...
                {
                    modItem.onHit = "Curse";
                    modItem.onHitChance = modifierValues[HasMod(17)];
                ...
                {
                    modItem.onHit = "Leech";
                    modItem.onHitChance = modifierValues[HasMod(18)];
